...
You can find the docs for this first-party plugin in the [official Godot docs](https://docs.godotengine.org/en/3.6/tutorials/platform/android/android_in_app_purchases.html).
